...
function change_email(query,res,req)
{
    if(query.uid&&query.access_token&&query.email)
    {
        mongodb.twesix.user.change_email(query.uid,query.access_token,query.email)
            .then(function(data)
            {
